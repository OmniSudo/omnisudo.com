...
using SkillQuest.Server.Addon.SkillQuest.Database.Users;
using SkillQuest.Shared.Addon.SkillQuest.Packet.Credentials;

namespace SkillQuest.Server.Addon.SkillQuest.Doohickey.Users;

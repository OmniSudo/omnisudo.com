...
using SkillQuest.Server.Addon.SkillQuest.Doohickey.Character;
using SkillQuest.Server.Addon.SkillQuest.Doohickey.Users;
using SkillQuest.Server.Engine;
using SkillQuest.Shared.Addon.SkillQuest.Doohickey.Addon;
using SkillQuest.Shared.Addon.SkillQuest.Packet.Character;
using SkillQuest.Shared.Engine.Database;

namespace SkillQuest.Server.Addon.SkillQuest.Doohickey.Addon;
...
public class AddonSkillQuestSV : AddonSkillQuestSH{
    ...
    async void OnMounted(IAddon addon, IApplication? application){
        SV.Database = new SqliteDatabase("addon/skillquest/SkillQuest.Server.Addon/assets/database/skillquest.db");

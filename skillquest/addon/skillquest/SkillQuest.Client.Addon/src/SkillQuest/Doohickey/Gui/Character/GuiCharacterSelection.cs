...
using SkillQuest.Client.Addon.SkillQuest.Doohickey.Character;
using SkillQuest.Client.Addon.SkillQuest.Doohickey.Gui.InGame;
...
namespace SkillQuest.Client.Addon.SkillQuest.Doohickey.Gui.Character;
